...
| `employment-models.png` | Employment model schema diagram (PNG export, 784×554) |
...
```bash
PYTHONPATH=src:. uv run python3 -m pytest -q tests/            # 248 passed
