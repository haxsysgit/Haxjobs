...
|---|---|---|---|
| R-001 | The Plan 004 baseline was documented as 248 tests, while the live baseline was 269. | Restamped current docs and report to the measured 274-test post-repair suite. | `README.md`, `docs/HAXJOBS.md`, `report.md` |
...
| R-003 | The original decision trajectory coverage omitted the requested Job 49 direct skip/correction/apply/resume paths. | Added fake, no-network trajectories with a real Job 49 assessment before the user skip, durable history, and same-scope resume recall assertions. | `tests/test_trajectory_job_328.py` |
...
| R-007 | Current docs and delivery text overstated completion and had stale test counts. | Updated current docs and delivery report/README/ledger to candidate reality, 274 tests, and pending review. Left `plans/README.md` untouched. | `README.md`, `docs/`, `deliverables/005-job-decisions/` |
