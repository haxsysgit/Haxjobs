...
Usage:
    from haxjobs.evaluate.chain import evaluate_one_job, evaluate_batch
    result = evaluate_one_job(job_dict)
"""

from __future__ import annotations

from haxjobs.config import EVALUATION_AGENT, EVALUATION_FALLBACK_AGENTS
from haxjobs.evaluate.common import build_prompt
from haxjobs.evaluate.agents import AGENT_LIST, auto_discover
