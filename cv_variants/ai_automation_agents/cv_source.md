...
**Pipeline Systems:** cron workflows, job discovery, role-family classification, pack generation, source-first scraping, state tracking

**Testing and Quality:** Advanced pytest, deterministic classifiers, regression tests, validation gates, test-driven development

**Infrastructure and Tools:** Docker, Linux, Git/GitHub, cloud VPS operations, structured logging
...
*Python, FastAPI, SQLite, React, TypeScript, browser automation*
[github.com/haxsysgit/Haxjobs](https://github.com/haxsysgit/Haxjobs)

Built HaxJobs to discover roles, classify them into role families, evaluate fit, and produce review-ready application packs that reference reusable CV variants. The point is not blind auto-apply. The point is staged automation with review gates, because job automation without judgment becomes spam in a hoodie.

- Built source-first discovery across ATS platforms such as Lever, Ashby, and Greenhouse.
- Added deterministic role-family classification so reusable CV variants can be selected without LLM guesswork.
- Created markdown-first packs that reference a stable CV instead of generating a new CV per job.

### Haxaml, Agent Governance Runtime
*Python, MCP, FRAME*
